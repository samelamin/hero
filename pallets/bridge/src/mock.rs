...
pub(crate) const ENDOWED_BALANCE: Balance = 10000 * HERO;
pub(crate) const RELAYER_B_INITIAL_BALANCE: Balance = 2000 * HERO;
...
// Parameterize chainbridge substrate repo
parameter_types! {
...
// Implement Chain chainbridge substrate repo configuration trait for the mock runtime
...
parameter_types! {
	...
	pub NativeTokenId: ResourceId = chainbridge::derive_resource_id(1, &blake2_128(b"xHero"));
